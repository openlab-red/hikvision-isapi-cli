...
if TYPE_CHECKING:
    from ..models.root_type_for_xml_streaming_channel_streaming_channel_audio_audio_compression_type import (
        RootTypeForXMLStreamingChannelStreamingChannelAudioAudioCompressionType,
    )
    from ..models.root_type_for_xml_streaming_channel_streaming_channel_audio_audio_inbound_compression_type import (
        RootTypeForXMLStreamingChannelStreamingChannelAudioAudioInboundCompressionType,
    )
    from ..models.root_type_for_xml_streaming_channel_streaming_channel_audio_voice_changer import (
        RootTypeForXMLStreamingChannelStreamingChannelAudioVoiceChanger,
    )


T = TypeVar("T", bound="RootTypeForXMLStreamingChannelStreamingChannelAudio")


@attr.s(auto_attribs=True)
class RootTypeForXMLStreamingChannelStreamingChannelAudio:
    """
    Attributes:
        enabled (Union[Unset, str]):
        audio_input_channel_id (Union[Unset, str]):
        audio_compression_type (Union[Unset, RootTypeForXMLStreamingChannelStreamingChannelAudioAudioCompressionType]):
        ...
        voice_changer (Union[Unset, RootTypeForXMLStreamingChannelStreamingChannelAudioVoiceChanger]):
    """

    enabled: Union[Unset, str] = UNSET
    audio_input_channel_id: Union[Unset, str] = UNSET
    audio_compression_type: Union[
        Unset, "RootTypeForXMLStreamingChannelStreamingChannelAudioAudioCompressionType"
    ] = UNSET
    audio_inbound_compression_type: Union[
        Unset, "RootTypeForXMLStreamingChannelStreamingChannelAudioAudioInboundCompressionType"
    ] = UNSET
    audio_bit_rate: Union[Unset, str] = UNSET
    audio_sampling_rate: Union[Unset, str] = UNSET
    audio_resolution: Union[Unset, str] = UNSET
    voice_changer: Union[Unset, "RootTypeForXMLStreamingChannelStreamingChannelAudioVoiceChanger"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_audio_compression_type, Unset):
            ...
            audio_compression_type = RootTypeForXMLStreamingChannelStreamingChannelAudioAudioCompressionType.from_dict(
        ...
        if isinstance(_audio_inbound_compression_type, Unset):
            ...
            audio_inbound_compression_type = (
                RootTypeForXMLStreamingChannelStreamingChannelAudioAudioInboundCompressionType.from_dict(
        ...
        if isinstance(_voice_changer, Unset):
            ...
            voice_changer = RootTypeForXMLStreamingChannelStreamingChannelAudioVoiceChanger.from_dict(_voice_changer)

        root_type_for_xml_streaming_channel_streaming_channel_audio = cls(
            enabled=enabled,
        ...
        root_type_for_xml_streaming_channel_streaming_channel_audio.additional_properties = d
        return root_type_for_xml_streaming_channel_streaming_channel_audio
