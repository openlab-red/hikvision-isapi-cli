...
if TYPE_CHECKING:
    from ..models.root_type_for_xml_streaming_channel_streaming_channel_custom_stream_enable_streaming_channel_transport_multicast_active_multicast_enabled import (
        RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticastActiveMulticastEnabled,
    )
    from ..models.root_type_for_xml_streaming_channel_streaming_channel_custom_stream_enable_streaming_channel_transport_multicast_fec_info import (
        RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticastFecInfo,
    )


T = TypeVar(
    "T", bound="RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticast"
)


@attr.s(auto_attribs=True)
class RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticast:
    """
    Attributes:
        ...
        ttl (Union[Unset, str]):
        active_multicast_enabled (Union[Unset, RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreaming
            ChannelTransportMulticastActiveMulticastEnabled]):
        packaging_format (Union[Unset, str]):
        fec_info (Union[Unset,
            RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticastFecInfo]):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_active_multicast_enabled, Unset):
            ...
            active_multicast_enabled = RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticastActiveMulticastEnabled.from_dict(
        ...
        if isinstance(_fec_info, Unset):
            ...
            fec_info = RootTypeForXMLStreamingChannelStreamingChannelCustomStreamEnableStreamingChannelTransportMulticastFecInfo.from_dict(
                _fec_info
            )

        root_type_for_xml_streaming_channel_streaming_channel_custom_stream_enable_streaming_channel_transport_multicast = cls(
            enabled=enabled,
        ...
        root_type_for_xml_streaming_channel_streaming_channel_custom_stream_enable_streaming_channel_transport_multicast.additional_properties = (
            d
        )
        return root_type_for_xml_streaming_channel_streaming_channel_custom_stream_enable_streaming_channel_transport_multicast
