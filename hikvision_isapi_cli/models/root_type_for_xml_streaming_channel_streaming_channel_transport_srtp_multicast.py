...
T = TypeVar("T", bound="RootTypeForXMLStreamingChannelStreamingChannelTransportSRTPMulticast")


@attr.s(auto_attribs=True)
class RootTypeForXMLStreamingChannelStreamingChannelTransportSRTPMulticast:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        root_type_for_xml_streaming_channel_streaming_channel_transport_srtp_multicast = cls(
            srtp_video_dest_port_no=srtp_video_dest_port_no,
            srtp_audio_dest_port_no=srtp_audio_dest_port_no,
        )

        root_type_for_xml_streaming_channel_streaming_channel_transport_srtp_multicast.additional_properties = d
        return root_type_for_xml_streaming_channel_streaming_channel_transport_srtp_multicast
