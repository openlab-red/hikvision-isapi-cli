...
) -> Optional[Union[RootTypeForXMLDeviceInfo, RootTypeForXMLResponseStatus]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = RootTypeForXMLDeviceInfo.from_dict(xmltodict.parse(response.text))
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[RootTypeForXMLDeviceInfo, RootTypeForXMLResponseStatus]]:
    return Response(
